...
namespace ScannitSharp.Bindings.Models
{
    ...
    public class PeriodPass
    {
        ...
        public OneOf<OldZone, NewZone, ValidityAreas.Vehicle> ValidityArea1 { get; set; }
        ...
        public OneOf<OldZone, NewZone, ValidityAreas.Vehicle> ValidityArea2 { get; set; }
        ...
        public OneOf<Zone, BoardingAreas.Vehicle, ZoneCircle> LastBoardArea { get; set; }
    ...
    public class ETicket
    {
        ...
        public OneOf<OldZone, NewZone, ValidityAreas.Vehicle> ValidityArea { get; set; }
        ...
        public OneOf<OldZone, NewZone, ValidityAreas.Vehicle> PeriodPassValidityArea { get; set; }
        public OneOf<FaresFor2010, FaresFor2014> ExtensionProductCode { get; set; }
        public OneOf<OldZone, NewZone, ValidityAreas.Vehicle> ExtensionValidityArea1 { get; set; }
        public ushort ExtensionFareCents1 { get; set; }
        public OneOf<OldZone, NewZone, ValidityAreas.Vehicle> ExtensionValidityArea2 { get; set; }
        ...
        public OneOf<Zone, BoardingAreas.Vehicle, ZoneCircle> BoardingArea { get; set; }

        internal ETicket(FFIETicket eTicket)
        {
            ProductCode = ProductCodes.ProductCode.Create(eTicket.product_code_kind, eTicket.product_code_value);
            CustomerProfile = eTicket.customer_profile;
            Language = eTicket.language;
            ValidityLength = ValidityLengths.ValidityLength.Create(eTicket.validity_length_kind, eTicket.validity_length_value);
            ValidityArea = ValidityAreas.ValidityArea.Create(eTicket.validity_area_kind, eTicket.validity_area_value);
            SaleDateTime = DateTimeOffset.FromUnixTimeSeconds(eTicket.sale_datetime);
            SaleDevice = SaleDevices.SaleDevice.Create(eTicket.sale_device_kind, eTicket.sale_device_value);
            TicketFareCents = eTicket.ticket_fare_cents;
            GroupSize = eTicket.group_size;
            ExtraZone = eTicket.extra_zone != 0;
            PeriodPassValidityArea = ValidityAreas.ValidityArea.Create(eTicket.period_pass_validity_area_kind, eTicket.period_pass_validity_area_value);
            ExtensionProductCode = ProductCodes.ProductCode.Create(eTicket.extension_product_code_kind, eTicket.extension_product_code_value);
            ExtensionValidityArea1 = ValidityAreas.ValidityArea.Create(eTicket.extension_1_validity_area_kind, eTicket.extension_1_validity_area_value);
            ExtensionFareCents1 = eTicket.extension_1_fare_cents;
            ExtensionValidityArea2 = ValidityAreas.ValidityArea.Create(eTicket.extension_2_validity_area_kind, eTicket.extension_2_validity_area_value);
            ...
            BoardingLocation = BoardingLocations.BoardingLocation.Create(eTicket.boarding_location_kind, eTicket.boarding_location_value);
            BoardingDirection = eTicket.boarding_direction;
            BoardingArea = BoardingAreas.BoardingArea.Create(eTicket.boarding_area_kind, eTicket.boarding_area_value);
        }
    }
